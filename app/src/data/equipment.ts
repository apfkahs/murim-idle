...
export const EQUIPMENT: EquipmentDef[] = [
  ...
  // ── 배화교 검법 장비 ──
  {
    ...
    slot: 'weapon',
    rarity: 'superior',
    stats: { bonusAtk: 130, bonusCritRate: 0.09, bonusCritDmgPercent: 0.11 },
    ...
    enhanceSteps: [
      { maxUnits: 150, probabilityPerUnit: 1 / 150, maxChance: 1.0,
        stats: { bonusAtk: 145, bonusCritRate: 0.10, bonusCritDmgPercent: 0.13 } },
  ...
  },
  {
    ...
    slot: 'armor',
    rarity: 'superior',
    stats: { bonusFixedDmgReduction: 30, bonusHpPercent: 0.18 },
    ...
    enhanceSteps: [
      { maxUnits: 150, probabilityPerUnit: 1 / 150, maxChance: 1.0,
        stats: { bonusFixedDmgReduction: 36, bonusHpPercent: 0.20 } },
      { maxUnits: 300, probabilityPerUnit: 1 / 300, maxChance: 1.0,
